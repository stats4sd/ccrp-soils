...
@section('content')
    ...
    <nav class="mt-5">
        <ul class="nav nav-tabs mr-auto" id="project-tabs" role="tablist">
            <li class="nav-item">
                <a href="#forms" class="nav-link active" id="forms-tab" data-toggle="tab" role="tab"
                   aria-controls="forms" aria-selected="true">{{ t("Data Collection Forms") }}</a>
            </li>
            <li class="nav-item">
                <a href="#data" class="nav-link" id="data-tab" data-toggle="tab" role="tab" aria-controls="data"
                   aria-selected="true">{{ t("Project Data") }}</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="#members" class="nav-link" id="members-tab" data-toggle="tab" role="tab"
                   aria-controls="members" aria-selected="true">{{ t("Project Members") }}</a>
            </li>
            <li class="nav-item">
                <a href="#settings" class="nav-link" id="settings-tab" data-toggle="tab" role="tab"
                   aria-controls="settings" aria-selected="true">{{ t("Project Settings") }}</a>
            </li>
        </ul>
    </nav>
            ...
            <div class="tab-pane fade show active" id="forms" role="tabpanel" aria-labelledby="forms-tab">
                @if(!auth()->user()->kobo_id)
                    <div class="alert alert-info text-dark">
                        {{ t("Note - you have not entered your KoboToolbox Username, which means you will not be able to see these formson KoboToolbox or ODK Collect. You can update your account here:") }}
                        <a href="{{ route('users.edit', auth()->user()) }}">{{ t("My Account") }}</a>.<br/><br/>
...
")) !!}
                ...
                <a href="{{ route('projects.samples.download-wide', $project) }}"
                   class="btn btn-success">{{ t("Download sample data in wide format") }}</a>
                <a href="{{ route('projects.samples.download-long', $project) }}"
                   class="btn btn-success">{{ t("Download sample data in split format") }}</a>
                <project-data-table
